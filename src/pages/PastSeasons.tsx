    ...
    <section className="container-std py-16 text-white">
      <FloatIn delay={0}>
        <div className="text-center mb-12">
          <h1 className="text-5xl md:text-6xl font-black tracking-tight">Past Seasons</h1>
      ...
      <div className="space-y-10">
        {list.map((season, index) => (
          <FloatIn key={season.season} delay={100 + index * 80}>
            <article
              className="rounded-3xl border border-white/10 bg-gradient-to-br from-black via-zinc-900 to-neutral-900 p-8 shadow-2xl shadow-black/40"
            >
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  <p className="text-xs uppercase tracking-[0.4em] text-red-300">Season</p>
              ...
              <div className="mt-6 grid gap-6 md:grid-cols-2">
                {season.highlights.map((highlight) => (
                  ...
                  >
                    <h3 className="text-lg font-semibold text-white">{highlight.event}</h3>
